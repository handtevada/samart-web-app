        ...
        <div className="container mx-auto px-4 text-center max-w-4xl">
          ...
          <h1 className="text-3xl md:text-5xl font-bold text-gray-900 leading-tight mb-6">
            ...
            <span className="text-orange-500">
              เลือกสามารถเอ็ดดูแคร์เนอสเซอรี่
            </span>
          </h1>
          <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto">
            Samart Edu-Care Nursery -
            สถานที่ที่ลูกน้อยของคุณจะได้รับการดูแลอย่างดีที่สุด
            ด้วยความรักและความเข้าใจในพัฒนาการของเด็กปฐมวัย
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="https://www.facebook.com/samarteducarenursery"
              className="w-full sm:w-auto px-8 py-3 bg-orange-500 text-white rounded-full font-bold text-lg hover:bg-orange-600 hover:shadow-lg transition-all"
            >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              เรามุ่งเน้นการดูแลที่ครอบคลุม ทั้งด้านร่างกาย อารมณ์ จิตใจ สังคม
              และสติปัญญา
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-10">
              ชมภาพบรรยากาศความน่ารัก ความสนุกสนาน และกิจกรรมการเรียนรู้ต่างๆ
              ของเด็กๆ ได้ที่อัลบั้มรูปภาพของเราบน Facebook
            </p>
            <Link
      ...
      <ul className="space-y-3">
        {items.map((item, index) => (
          <li key={index} className="flex items-start gap-2">
            ...
            />
            <span className={highlight ? "text-orange-50" : "text-gray-600"}>
              {item}
            </span>
          </li>
        ))}
